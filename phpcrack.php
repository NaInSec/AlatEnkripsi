<?php
/*
 * Usage: php phpcrack.php -w wordlist.txt -c 7c4a8d09ca3762af61e59520943dc26494f8941b -t md5
 * Arguments:
 * -w <wordlist> : Memilih daftar kata atau "stdin" untuk masukan standar.
 * -s <nomor baris mulai> : Lewati baris dari daftar kata.
 * -o <file output> : Simpan sesi/hasil ke file.
 * -f <file output> : Pulihkan sesi yang rusak.
 * -c <hash> : Hash yang akan dipecahkan.
 * -t <jenis hash> : Jenis hash yang digunakan.
 * -l <salt kiri> : Salt yang ditambahkan ke awal password.
 * -r <salt kanan> : Salt yang ditambahkan ke akhir password.
 * -d <s> : Hash <s> dengan semua jenis hash yang didukung.
